...
import Postpf from './Postpf'
import './Postpf.css'
import { useState,useEffect } from 'react'
import { IconButton } from '@material-ui/core'
import { useNavigate } from 'react-router-dom'
import './Profile.css'
import { ProfileProps } from '../Interface/ProfileIntrfce'

function Profile() {
    const [vpost, setVpost] = useState<ProfileProps[]>([]);
      ...
      return (
        ...
        <div className="cols__container">
          <div className="left__col">
            ...
            <li><span onClick={pndhflower} className='flwr'>{y.Following}</span>Followers</li>
            </IconButton>
              <IconButton>
              <li><span onClick={pndhflwing} className='flwing'>{y.Follower}</span>Following</li>
              </IconButton>
